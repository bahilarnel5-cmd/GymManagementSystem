...
export default function CoachSchedules() {
  ...
  const addSchedule = (coachId, day, shift) => {
                  ...
                  {SHIFT_OPTIONS.map((shift) => {
                    ...
                    return (
                      <td key={shift} className="px-5 py-3 text-center">
                        {exists ? (
                          <span className="inline-flex px-4 py-2 rounded-xl text-xs font-semibold bg-emerald-100 text-emerald-700">
                          ...
                          <button
                            onClick={() => {
                              ...
                              if (coachId) addSchedule(coachId, dayIdx, shift)
                            }}
                            disabled={!selectedCoach && coaches.length === 0}
                            className="px-4 py-2 rounded-xl text-xs font-semibold transition-all bg-gray-100 text-gray-400 hover:bg-cyan-50 hover:text-cyan-600"
                          >
